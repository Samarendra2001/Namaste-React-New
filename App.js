    ...
    <div className="res-card" style={{ backgroundColor: "#f0f0f0" }}>
      <img
        ...
        src={
          ...
          cloudinaryImageId
        }//THIS IS bcz as it is use CDN for hosting all the images and the id is different for all images so we have concatenate id with that link
      />
      {/* <h3>{resData.data.name}</h3>
      <h4>{resData.data.cuisines.join(", ")}</h4>
      <h4>{resData.data.avgRating} stars</h4>
      <h4>₹{resData.data.costForTwo / 100} FOR TWO</h4>   As you can see here we have to write for every line resData.data . to get rid of this we used resData?.dat in above 
  ...
  return (
    <div className="body">
      ...
      <div className="res-container">
        {/* <RestaurantCard resData = {resList[0]}/>  this can be written also. here as you can see resData represents resList which is pass ovr above as props
        <RestaurantCard resData = {resList[0]}/> */}
        {resList.map((restaurant) => (
          <RestaurantCard key={restaurant.data.id} resData={restaurant} />//whatever you pass in it , it'll go as props in above as resData goes here so in above it will go as props
        ))}
      </div>
    </div>
  );
